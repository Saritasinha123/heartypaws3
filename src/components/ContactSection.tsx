...
import { Phone, MapPin, Clock, Calendar, Send, CheckCircle2, User, HelpCircle, Mail, AlertCircle, Instagram, Facebook } from 'lucide-react';
...
export default function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!form.serviceNeeded) return setError('Please select a service.');
    if (!form.date) return setError('Please select an appointment date.');
    if (!form.time) return setError('Please choose a preferred time slot.');
...
Submitted from:
Hearty Paws Pet Spa & Clinic Website`;
    ...
    setSuccessMessage('WhatsApp opened successfully. Please tap Send to confirm your appointment.');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-10 border border-teal-100/50 shadow-sm flex flex-col justify-between">
            <div>
              ...
              {successMessage && (
                <div className="mb-4 bg-teal-50 border border-teal-100 text-brand-teal p-3 rounded-xl text-xs flex items-center gap-2">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full sm:w-auto bg-brand-teal hover:bg-brand-teal-light text-white text-sm font-extrabold px-6 py-3.5 rounded-xl shadow-md transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer"
                  >
